...
## Summary and some plots of dataset car 
...
```
## Question: How stopping time depends on car speed? 
...
```
And see summary function from model with quadratic term and without intercept.
```{r}
summary(cars_lm3)
```
...
## Question 02: Which model do you prefer and why?

I guess, model number 3. And why? Because I like Tesla model 3. Hahaha.
